%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% Random Functions from the GP posterior
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clear all
close all
clc
disp('---------------------------------------------------------------------')
disp(' Random Functions from a GP posterior  ')
disp('---------------------------------------------------------------------')
%%%%%%%%%%%%%%%%%%%%%%%%%%%
T_obs=[-10 -2 4 10]; 
Y_obs=[3 1 -7 5];%%%% we assume that are contaminated by additive Guassian noise
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 %%%%%%%%%%%%% OBSERVATION NOISE 
 sig_noise=1;
 SIGMA_Noise=sig_noise*eye(N);
 disp(' ')
 disp('We assume the following observation model: Y =f(t)+E ')
 disp('where f is a Gaussian process and ')
 disp(['E is a Gaussian random Variable of zero mean and variance ',num2str(sig_noise)])
 disp(' ')
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 %%%%  POSTERIOR PARAMETERS %%
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 mu_post=Sigma_training_test*(SIGMA_TRAINING+SIGMA_Noise)^(-1)*Y_obs'; %%% MEAN
 %%% COVARIANCE 
 SIGMA_POST=SIGMA_PRIOR-Sigma_training_test*(SIGMA_TRAINING+SIGMA_Noise)^(-1)*Sigma_training_test';
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
NUMCURVES=20;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
